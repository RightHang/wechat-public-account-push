...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx62b8b1e6a18b4327',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'edb34168b24a83e3afc8f77af9894c94',
  ...
  USERS: [
    {
      ...
      useTemplateId: 'RYomJFOhs5OpI7g4JWEIHx_2uSZlhuwQ4-kcTwOr99E',
      // 所在省份或城市，也可以不填
      province: '广东',
      // 所在城市或县区
      city: '肇庆',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小柔宝贝', year: '2001', date: '11-28',
        },
        {
          type: '*生日', name: '你的男朋友生日', year: '1997', date: '04-05',
        },
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2024-05-20' }
      ],
      // 课程表相关配置
